...
(function() {
  var BetokenFund, BigNumber, CO, CompoundOrder, DAI, DAI_PRICE, DAY, ETH_PRICE, EXIT_FEE, FUND, KN, KRO, MiniMeToken, MiniMeTokenFactory, OMG_PRICE, PHASE_LENGTHS, PRECISION, ST, TK, TestCompound, TestKyberNetwork, TestToken, TestTokenFactory, ZERO_ADDR, bnToString, calcRegisterPayAmount, epsilon, epsilon_equal, timeTravel;
  ...
  contract("price_changes", function(accounts) {
    ...
    it("raise_asset_price", async function() {
      var MAX_PRICE, delta, investmentId, kn, kro, kroBlnce, newPrice, omg, prevKROBlnce, stake, tokenAmount;
