...
(function() {
  var BetokenFund, BetokenProxy, BigNumber, CO, CPD, CompoundOrder, DAI, DAI_PRICE, DAY, ETH_ADDR, ETH_PRICE, FUND, INACTIVE_THRESHOLD, KN, KRO, LONG_LEVERAGE, MiniMeToken, MiniMeTokenFactory, OMG_PRICE, PHASE_LENGTHS, PRECISION, SHORT_LEVERAGE, ST, TK, TestCompound, TestKyberNetwork, TestToken, TestTokenFactory, ZERO_ADDR, bnToString, calcRegisterPayAmount, epsilon, epsilon_equal, timeTravel;
