...
loadFundData = function() {
  ...
  Promise.all([
    ...
    betoken.getPrimitiveVar("totalStaked").then(function(_result) {
      return totalStaked.set(BigNumber(_result));
    })
  ]).then(function() {
    return Promise.all([
