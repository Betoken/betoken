...
var INPUT_ERR, SEND_TX_ERR, STAKE_BOTH_SIDES_ERR, Web3, againstProposalList, avgROI, betoken, betoken_addr, chart, checkIfStakedOnOtherSide, checkKairoAmountError, clock, commissionRate, copyTextToClipboard, countdownDay, countdownHour, countdownMin, countdownSec, createdProposalCount, cycleNumber, cyclePhase, cycleTotalForStake, displayedKairoBalance, displayedKairoUnit, errorMessage, etherDeltaAddr, hasWeb3, kairoAddr, kairoBalance, kairoTotalSupply, loadFundData, maxProposals, maxProposalsPerMember, memberList, minStakeProportion, networkName, networkPrefix, oraclizeAddr, paused, prevCommission, prevROI, proposalList, showCountdown, showError, showSuccess, showTransaction, startTimeOfCyclePhase, successMessage, supportedProposalList, timeOfChangeMaking, timeOfProposalMaking, timeOfSellOrderWaiting, timeOfWaiting, totalCommission, totalFunds, transactionHash, transactionHistory, userAddress, userBalance, web3;
...
loadFundData = function() {
  ...
  betoken.getPrimitiveVar("etherDeltaAddr").then(function(_etherDeltaAddr) {
    return etherDeltaAddr.set(_etherDeltaAddr);
  });
...
Template.top_bar.helpers({
  ...
  oraclize_addr: function() {
    return oraclizeAddr.get();
  },
  etherdelta_addr: function() {
    return etherDeltaAddr.get();
  },
  network_prefix: function() {
    return networkPrefix.get();
  }
