...
loadFundData = async function() {
  var ROI, _event, commission, data, events, getDepositWithdrawHistory, getTransferHistory, handleAllProposals, handleProposal, i, investments, j, k, len, len1, receivedROICount, userAddr;
  investments = [];
  receivedROICount = 0;
  /*
   * Get fund data
  ...
  if (hasWeb3) {
    ...
    if (investments.length !== 0) {
      ...
      handleAllProposals = (function() {
        var l, ref, results;
        results = [];
        for (i = l = 0, ref = investments.length - 1; (0 <= ref ? l <= ref : l >= ref); i = 0 <= ref ? ++l : --l) {
    ...
    getDepositWithdrawHistory = async function(_type) {
      var entry, event, l, len2, results, tmp;
    ...
    getTransferHistory = async function(token, isIn) {
      var entry, l, len2, results, tmp, tokenContract;
...
$("document").ready(function() {
  ...
  if (web3 != null) {
    ...
    return betoken.init().then(loadFundData).then(postFundLoad);
  }
});
