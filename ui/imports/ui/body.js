...
loadRanking = async function() {
  var _event, dupFlag, events, j, k, l, len, len1, len2, rank, ranking, results, u, user, userKairoBalance;
  // load Kairo ranking
  kairoRanking.set([]);
  ...
  for (j = 0, len = events.length; j < len; j++) {
    ...
    rank = 1;
    for (l = 0, len2 = ranking.length; l < len2; l++) {
      u = ranking[l];
      u.rank = rank;
      rank += 1;
    }
