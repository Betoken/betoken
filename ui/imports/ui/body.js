...
loadFundData = function() {
  ...
  betoken.getPrimitiveVar("proposalsAreSold").then(function(_result) {
    return proposalsAreSold.set(_result);
  });
...
Template.top_bar.helpers({
  ...
  next_phase_is_disabled: function() {
