...
var SEND_TX_ERR, Web3, avgROI, betoken, betoken_addr, chart, clock, commissionRate, countdownDay, countdownHour, countdownMin, countdownSec, cycleNumber, cyclePhase, displayedKairoBalance, displayedKairoUnit, errorMessage, etherDelta_addr, kairoBalance, kairoTotalSupply, kairo_addr, loadFundData, memberList, networkName, networkPrefix, prevCommission, prevROI, proposalList, showCountdown, showError, showTransaction, startTimeOfCycle, supportedProposalList, timeOfChangeMaking, timeOfCycle, timeOfProposalMaking, timeOfSellOrderWaiting, totalCommission, totalFunds, transactionHash, transactionHistory, userAddress, userBalance, web3;
...
$('document').ready(function() {
  ...
  if (typeof web3 !== void 0) {
    ...
    return showError("Betoken can only be used in a Web3 enabled browser. Please install Metamask or switch to another browser that supports Web3.");
  }
});
