...
var INPUT_ERR, SEND_TX_ERR, STAKE_BOTH_SIDES_ERR, Web3, againstProposalList, avgROI, betoken, betoken_addr, chart, checkIfStakedOnOtherSide, checkKairoAmountError, clock, commissionRate, copyTextToClipboard, countdownDay, countdownHour, countdownMin, countdownSec, createdProposalCount, cycleNumber, cyclePhase, cycleTotalForStake, displayedKairoBalance, displayedKairoUnit, errorMessage, etherDelta_addr, hasWeb3, kairoBalance, kairoTotalSupply, kairo_addr, loadFundData, maxProposalsPerMember, memberList, minStakeProportion, networkName, networkPrefix, paused, prevCommission, prevROI, proposalList, showCountdown, showError, showSuccess, showTransaction, startTimeOfCyclePhase, successMessage, supportedProposalList, timeOfChangeMaking, timeOfProposalMaking, timeOfSellOrderWaiting, timeOfWaiting, totalCommission, totalFunds, transactionHash, transactionHistory, userAddress, userBalance, web3;
