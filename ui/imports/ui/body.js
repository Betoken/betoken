...
loadFundData = async function() {
  var ROI, _event, commission, data, events, getDepositWithdrawHistory, getTransferHistory, handleAllProposals, handleProposal, i, investments, j, k, len, len1, net, netID, pre, receivedROICount, userAddr;
  investments = [];
  receivedROICount = 0;
  // Get Network ID
